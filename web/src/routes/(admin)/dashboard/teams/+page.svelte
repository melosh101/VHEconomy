...
<div class="p-6">
	<h1 class="mb-6 text-2xl font-bold">Manage Teams</h1>
	...
	<div class="bg-base-200 mb-8 rounded-xl p-4">
		<h2 class="mb-4 text-xl font-semibold">Add Team</h2>
						...
						{:else}
							...
							<td>
								<div class="flex items-center gap-2">
									<div class="h-4 w-4 rounded" style="background-color: {t.color || '#ccc'}"></div>
									{t.color || 'None'}
								</div>
							</td>
							<td class="flex gap-2">
								<button class="btn btn-ghost btn-xs" onclick={() => startEdit(t.id)}>Edit</button>
